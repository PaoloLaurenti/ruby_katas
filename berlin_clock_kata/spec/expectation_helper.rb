class ExpectationHelper
  ...
  def expect_third_red_light_on
    @listener.should_receive('third_red_light_on')
    @listener.should_not_receive('third_red_light_off')
  end
  ...
  def expect_fourth_red_light_on
    @listener.should_receive('fourth_red_light_on')
    @listener.should_not_receive('fourth_red_light_off')
  end
